...
<html lang="en">
  <head>
    ...
    <title>Formulir Pesanan - Roti'O</title>
        ...
        <ul class="menu">
          ...
          <li class="menu-item-has-children current-menu-item">
            ...
            <ul class="sub-menu">
              ...
              <li class="current-menu-item"><a href="order-form.php">Formulir Pesanan</a></li>
            </ul>
          </li>
      ...
      <div class="ps-hero__content">
        ...
        <div class="ps-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="active">Formulir Pesanan</li>
          </ol>
        </div>
      </div>
    </div>
            ...
            <div class="ps-product ps-product--order-form">
              ...
              <div class="ps-product__content">
                ...
                <p class="ps-product__stock">
                  Stok: <span class="<?php echo $product['stock'] > 0 ? 'in-stock' : 'out-of-stock'; ?>">
                    <?php echo $product['stock'] > 0 ? $product['stock'] . ' tersedia' : 'Habis stok'; ?>
                  </span>
                </p>
              </div>
            </div>
